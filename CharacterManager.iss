...
OutputBaseFilename=CharacterManager-0.15.0-Setup
Compression=lzma
...
; Utilise toujours le dossier publish/ g̩n̩r̩ par dotnet publish
Source: "publish\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
; Raccourci dans le menu D̩marrage
...
[Run]
; Lancer l'application apr̬s installation
Filename: "{app}\CharacterManager.exe"; Description: "{cm:LaunchProgram,Character Manager}"; Flags: nowait postinstall skipifsilent

[UninstallDelete]
; Supprimer la base de donn̩es et les fichiers g̩n̩r̩s lors de la d̩sinstallation
